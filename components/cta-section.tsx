        ...
        <motion.div className="max-w-5xl mx-auto text-center bg-white dark:bg-gray-900 p-16 shadow-sm rounded-xl relative">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <button className="bg-[#104a74] dark:bg-[#1a6ca0] text-primary-foreground font-medium py-3 px-8 rounded-md hover:bg-[#104a74]/90 dark:hover:bg-[#1a6ca0]/90 transition-all">
                {t("cta.button")}
              </button>
            </motion.div>
          </motion.div>
