...
export default function Header() {
  ...
  return (
    <header className="bg-white dark:bg-gray-900 py-4 px-6 md:px-12 lg:px-20 border-b border-gray-100 dark:border-gray-800">
      <div className="container mx-auto flex justify-between items-center">
        ...
        >
          <LanguageSwitcher />
          <ThemeToggle />
          <button className="bg-[#104a74] dark:bg-[#1a6ca0] text-primary-foreground font-medium py-2.5 px-6 rounded-lg transition-all shadow-sm hover:bg-[#104a74]/90 dark:hover:bg-[#1a6ca0]/90">
